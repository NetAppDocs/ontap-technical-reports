...
This document contains information and best practices for configuring NetApp® SnapMirror® Asynchronous (SM-A) replication of FlexVol volumes, FlexGroup volumes, consistency groups and storage virtual machines.
