---
sidebar: sidebar
permalink: afx-performance.html
keywords: performance, benchmarks, throughput, specifications
summary: "Review AFX performance specifications, benchmark results, and performance enhancements for NFS and sequential I/O workloads."
---

= NetApp AFX performance specifications
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
[.lead]
NetApp AFX was built with performance and scale in mind, specifically geared toward workloads requiring high read and write throughput with simple, linear performance scaling. Review per-node and per-shelf performance estimates, benchmark results from production testing, and enhancements for NFS protocols and sequential I/O patterns.
...
image::image32.png[Unified ONTAP How performance is divided up]
...
image::image33.png[NetApp AFX Performance density]
...
image::image34.png[NetApp AFX ElBencho read performance]

.Figure 33) NetApp AFX – ElBencho write performance, 4 nodes
image::image35.png[NetApp AFX ElBencho write performance]
...
image::image36.png[NetApp AFX NFSv4.1 sequential IO performance]
...
image::image37.png[NetApp AFX NFSv4.1 metadata IO performance]
