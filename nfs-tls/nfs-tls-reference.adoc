...
summary: "NFS over TLS composes with standard ONTAP export-policy controls and replicates through SVM-DR and MetroCluster. This page also covers connection limits, enforcement behavior, and operational recommendations."
---
