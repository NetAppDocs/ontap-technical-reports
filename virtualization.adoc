...
These technical reports expand on the ONTAP tools for VMware vSphere link:https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere/index.html[ONTAP tools for VMware vSphere] product documentation.
