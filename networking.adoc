...
*link:https://www.netapp.com/pdf.html?item=/media/79703-TR-4949.pdf[TR-4949 BGP/VIP with ONTAP in the Datacenter – Quick Configuration Guide]* - Guide to help storage administrators quickly deploy a basic BGP configuration in NetApp® ONTAP®