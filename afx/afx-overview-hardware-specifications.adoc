---
sidebar: sidebar
permalink: afx-overview/afx-overview-hardware-specifications.html
keywords: afx, hardware, nodes, shelves, switches, disk
summary: "AFX hardware includes modular nodes based on AFF A1K, standard shelves with enhanced NSM140 modules, and 400GB capable switches."
---
...
[.lead]
NetApp AFX nodes are based on the AFF A1K model, containing no on-board disk storage and designed to be fully modular. AFX uses standard shelf enclosures with enhanced NSM140 modules and backend cluster switches that support 400GB connectivity.
...
image:image42.png["NetApp AFX 1K node details"]
...
image:image43.png["NetApp AFX shelf enclosure details"]
...
image:image44.png["NetApp AFX cluster switches"]
...
image:image45.png["NetApp AFX switch cabling"]
