---
sidebar: sidebar
permalink: afx-overview/afx-overview-architecture-fundamentals.html
keywords: afx, disaggregated ontap, architecture, compute capacity
summary: "AFX architecture differs from unified ONTAP in disk relationships, NVRAM replication, RAID groups, and deduplication domains."
---
...
[.lead]
NetApp AFX shifts how disks are presented to compute nodes, removes physical aggregates, and enables independent scaling of compute and capacity. Unlike unified ONTAP where nodes own disks, AFX nodes access all disks through a shared Storage Availability Zone.
