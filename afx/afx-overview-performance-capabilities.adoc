---
sidebar: sidebar
permalink: afx-overview/afx-overview-performance-capabilities.html
keywords: afx, performance, benchmark, nfs, throughput
summary: "AFX delivers high read and write throughput with linear scaling, aggressive readahead for media workloads, and improved NFSv4.x performance."
---
...
image:image34.png["NetApp AFX – ElBencho read performance, 4 nodes"]

image:image35.png["NetApp AFX – ElBencho write performance, 4 nodes"]
...
image:image36.png["NetApp AFX – NFSv4.1 sequential IO performance in ONTAP 9.18.1"]
...
image:image37.png["NetApp AFX – NFSv4.1 metadata IO performance in ONTAP 9.18.1"]
