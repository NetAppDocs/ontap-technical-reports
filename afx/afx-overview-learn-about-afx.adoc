---
sidebar: sidebar
permalink: afx-overview/afx-overview-learn-about-afx.html
keywords: afx, disaggregated ontap, compute nodes, storage availability zone
summary: "NetApp AFX is a disaggregated ONTAP architecture that lets you scale compute and capacity independently."
---
...
image:image4.png["Disaggregated ONTAP"]
