...
NOTE: See the link:afx-performance-benchmarks.html[Performance benchmark tips] section for guidance on reproducing these results.
...
>| link:afx-performance-benchmarks.html[Next: Performance benchmark tips]
|===
