...
NOTE: See the link:afx-performance-benchmark-tips-afx.html[Performance benchmark tips] section for guidance on reproducing these results.
...
>| link:afx-performance-benchmark-tips-afx.html[Next: Performance benchmark tips]
|===
