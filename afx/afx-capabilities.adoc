...
* Backend cluster network ports support only 100GB connections to the cluster switches on the AFX 1K platform and support 400GB connections on the AFX 2K.
* Because the cluster switches are 400GB capable, the backend node connections use 4 x 100GB breakout cables on the AFX 1K to reduce the number of ports used on the switches. The AFX 2K will use a 1:1 400GB connection to the switches.
...
For more information on how FlexGroup volumes benefit from AFX architecture, see link:afx-architecture-flexgroup.html#flexgroup-volume-management-improvements[FlexGroup volume management improvements].

[cols="1,1",frame=none,grid=none]
|===
| link:afx-management.html[Previous]
>| link:afx-hardware.html[Next: Hardware]
|===
