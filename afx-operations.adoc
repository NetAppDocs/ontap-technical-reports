---
sidebar: sidebar
permalink: afx-operations.html
keywords: management, operations, cli, gui, security, networking
summary: "Understand how AFX management tools, networking, security, and operations compare to unified ONTAP systems."
---

= NetApp AFX management and operations
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
[.lead]
While NetApp AFX has significant architectural differences from unified ONTAP, the feature set and management approach remain largely unchanged by design. This means minimal learning curve—AFX supports the same management tools, networking protocols, security features, and operational procedures as unified ONTAP, allowing you to apply existing expertise and automation scripts.
...
The only real differences in the NetApp AFX CLI have to do with what was added and what was removed (as covered in the "Features that have been removed or are unsupported" section of this document). If a feature (such as aggregates or Metrocluster) have been removed, then the corresponding CLI command will no longer be available.
...
[options="header"]
|===
| Unified ONTAP System Manager dashboard image::image38.png[Unified ONTAP System Manager] | NetApp AFX System Manager dashboard image::image39.png[NetApp AFX System Manager]
|===
