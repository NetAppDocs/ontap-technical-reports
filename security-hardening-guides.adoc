...
link:https://docs.netapp.com/us-en/ontap-apps-dbs/vmware/vmware-otv-hardening-overview.html.html[Security hardening guide for ONTAP tools for VMware vSphere]
