---
sidebar: sidebar
permalink: afx-hardware.html
keywords: hardware, specifications, nodes, shelves, disks
summary: "View the specifications for AFX nodes, shelf enclosures, cluster switches, and supported disk types."
---

= NetApp AFX hardware specifications
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
[.lead]
NetApp AFX clusters consist of modular nodes, high-capacity shelves, backend cluster switches, and NVMe SSDs optimized for disaggregated architecture. For the most current hardware information, consult the NetApp link:https://hwu.netapp.com[Hardware Universe^].
...
For performance numbers, see the "Per-shelf performance estimates" table in the Performance specifications page.
