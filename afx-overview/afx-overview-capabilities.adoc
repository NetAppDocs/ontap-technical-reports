...
For more information on how FlexGroup volumes benefit from AFX architecture, see link:afx-overview-architecture.html#flexgroup-volume-management-improvements[FlexGroup volume management improvements].
