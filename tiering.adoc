...
Learn about the recommended practices for deploying and sizing NetApp StorageGRID as a capacity tier for the NetApp ONTAP software component FabricPool. This document also covers core capabilities, requirements, implementation, and recommended practices when using StorageGRID.
