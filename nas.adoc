...
link:https://docs.netapp.com/us-en/ontap-technical-reports/nfs-over-tls/nfs-tls-overview.html[NFS over TLS in ONTAP^]
Learn how to encrypt NFS traffic in flight using TLS 1.3 without Kerberos or IPsec.