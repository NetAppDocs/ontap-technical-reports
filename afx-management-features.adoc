---
sidebar: sidebar
permalink: afx-management-features.html
keywords: management, automation, capacity, features, afx
summary: "Discover how AFX simplifies storage management through automated capacity handling, zero-copy volume moves, and intelligent failover and scaling."
---

= NetApp AFX management features
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
[.lead]
NetApp AFX management uses the same CLI, GUI, and REST APIs as unified ONTAP, but the disaggregated architecture enables significant operational improvements. Storage administrators can manage capacity as a single shared pool, automate volume rebalancing during failovers, and scale compute and capacity independently—simplifying many traditionally manual storage management tasks.
...
image::image19.png[Capacity CLI commands comparison]
...
image::image20.png[Unified ONTAP System Manager capacity views]
...
image::image21.png[NetApp AFX System Manager capacity views]
...
===== Node addition and removal in unified ONTAP
...
===== Node addition and removal in NetApp AFX
...
image::image28.png[Performance-driven volume moves high utilization triggers]

.Figure 27) Performance-driven volume moves in NetApp AFX – Balanced node utilization after volume move
image::image29.png[Performance-driven volume moves balanced node utilization after]
