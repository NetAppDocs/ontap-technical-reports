...
To learn more about securing LIFs, see the link:https://docs.netapp.com/us-en/ontap/networking/configure_firewall_policies_for_lifs.html[Configure firewall policies for LIFs^]. This page also provides detail about LIF service policies beginning with ONTAP 9.10.1.
To learn more about how to create a new service policy, see link:https://docs.netapp.com/us-en/ontap-cli/network-interface-service-policy-create.html[network interface service-policy create^]
