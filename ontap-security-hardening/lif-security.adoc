...
To learn more about how to create a new service policy, see link:https://docs.netapp.com/us-en/ontap-cli/network-interface-service-policy-create.html[the`network interface service-policy create` command in the Command Reference.^]
