...
NOTE: You cannot remove or rename built-in accounts. If an administrator removes the account, upon reboot, the built-in account will be recreated. *NetApp recommends* locking any unneeded built-in accounts with the lock command.
