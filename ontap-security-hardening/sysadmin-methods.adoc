...
For more information about MFA for ONTAP System Manager, Active IQ Unified Manager, and SSH, see link:https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf[TR-4647: Multifactor Authentication in ONTAP 9^].
