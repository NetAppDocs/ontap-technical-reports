...
keywords: tr-4569, ontap hardening guide, NFS, iSCSI, SMB, Kerberos, IKE v2, SVM, PSK, certificate, no license
summary: "IPsec provides an alternative to NFS or SMB encryption and is the only encryption in flight option for iSCSI traffic."
---
