...
link:https://www.netapp.com/pdf.html?item=/media/88704-tr-4976-virtualized-microsoft-sql-server-performance-on-netapp-aff-a-series-and-c-series.pdf[Virtualized Microsoft SQL Server performance on NetApp AFF A-Series and C-Series systems^]
Learn about the performance when running Microsoft SQL Server on NetApp AFF ASeries and AFF C-Series systems as well as get guidance on how to select the right system for your storage needs based on workload usage.
