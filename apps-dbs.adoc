...
== Epic EMR
link:https://docs.netapp.com/us-en/ontap-apps-dbs/epic/epic-overview.html[TR-3928-NetApp Best Practices for Epic^]
A guide to understanding the best practices for deploying Epic on Premises and in the Cloud while meeting configuration standards and GenIO testing for proper deployment with ONTAP.